...
module.exports.RadarSender = function(options) {
   ...
   * @param squaredDistance {Number} The squared distance.
   * @param crossSection {Number} The cross section of the target.
   */
  this.calcPowerDensityAtTarget = function(squaredDistance) {
...
module.exports.RadarReceiver = function(options) {
   ...
   * @param squaredDistance {Number} The squared distance
   */
  this.calcPowerDensityAtReceiver = function(squaredDistance, powerFromTarget) {
